...
# Set paths for the source of the split information and the target to apply the same split
source_dir_path = r'E:\TiledDataset224'
input_dir_path = r'E:\TiledImages299'  # Adjust if your input directory differs
